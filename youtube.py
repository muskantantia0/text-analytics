...
DEVELOPER_KEY = "AIzaSyAux9mnWe8giW19NmXZeu6HeQJnpEAFCBM"
...
def youtube_search(options):
    ...
    csvFile = open('video_results.csv','wb')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-results", help="Max results", default=22)
